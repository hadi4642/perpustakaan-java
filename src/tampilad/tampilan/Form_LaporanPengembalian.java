 ...
 * @author HP
 */
public class Form_LaporanPengembalian extends javax.swing.JFrame {
     ...
     */
    public Form_LaporanPengembalian() {
        initComponents();
        tampilDatabase();
        hitungData();
    }
    ...
    public void tampilDatabase() {
        ...
        tabel_laporanPengembalian.setModel(tabMode);
            try {
    ...
    private void initComponents() {
        ...
        tabel_laporanPengembalian = new javax.swing.JTable();
        ...
        jLabel3.setText("Laporan Pengembalian");

        tabel_laporanPengembalian.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, "", null},
            ...
            new String [] {
                "No Pengembalian", "NIM", "Nama Angota", "Tanggal Kembali", "Total Denda"
            }
        ));
        jScrollPane1.setViewportView(tabel_laporanPengembalian);
    ...
    private void btn_detailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_detailActionPerformed
        // TODO add your handling code here:
        int tabel_data = tabel_laporanPengembalian.getSelectedRow();        
        if(String.valueOf(tabel_data).equals("-1")){
            JOptionPane.showMessageDialog(this, "Pilih Data Yang Akan Ditampilkan !");
        }else
        {
//            detil_laporan_Pengembalian.public_no_Pengembalian = tabel.getValueAt(jTable1.getSelectedRow(), 0).toString();
//            detil_laporan_Pengembalian frameform = new detil_laporan_Pengembalian(null, true);
//            frameform.setVisible(true);
    ...
    private void hitungData() {
        int total_baris = tabel_laporanPengembalian.getRowCount();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_LaporanPengembalian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_LaporanPengembalian().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tabel_laporanPengembalian;
